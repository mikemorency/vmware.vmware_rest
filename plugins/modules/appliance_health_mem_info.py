...
short_description: Get the memory health of the vCenter Server Appliance.
description:
  - Returns the health status of the memory on the vCenter Server Appliance.
...
EXAMPLES = r"""
- name: Get the appliance memory health status
  vmware.vmware_rest.appliance_health_mem_info:
  register: mem_health

- name: Display the appliance memory health status
  ansible.builtin.debug:
    var: mem_health.value
"""

RETURN = r"""
value:
  description:
    - The health status of the appliance memory.
...
LIST_ENDPOINT = ""
ITEM_ENDPOINT = "/appliance/health/mem"
