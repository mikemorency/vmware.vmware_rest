...
short_description: Get the database storage health of the vCenter Server Appliance.
description:
  - Returns the health status of the storage used by the vCenter Server Appliance database.
...
EXAMPLES = r"""
- name: Get the appliance database storage health status
  vmware.vmware_rest.appliance_health_databasestorage_info:
  register: databasestorage_health

- name: Display the appliance database storage health status
  ansible.builtin.debug:
    var: databasestorage_health.value
"""

RETURN = r"""
value:
  description:
    - The health status of the appliance database storage.
...
LIST_ENDPOINT = ""
ITEM_ENDPOINT = "/appliance/health/database-storage"
