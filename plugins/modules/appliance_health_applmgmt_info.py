...
short_description: Get the health status of the appliance management (applmgmt) services.
description:
  - Returns the overall health status of the appliance management (applmgmt) services running on the vCenter Server Appliance.
...
EXAMPLES = r"""
- name: Get the appliance management services health status
  vmware.vmware_rest.appliance_health_applmgmt_info:
  register: applmgmt_health

- name: Display the appliance management health status
  ansible.builtin.debug:
    var: applmgmt_health.value
"""

RETURN = r"""
value:
  description:
    - The health status of the appliance management services.
...
LIST_ENDPOINT = ""
ITEM_ENDPOINT = "/appliance/health/applmgmt"
